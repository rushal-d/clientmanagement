...
<section class="padding-block">
    <div class="container-fluid">
        {{ Form::open(['route' => 'service.bulkupdate', 'method' => 'PATCH']) }}
            <div class="row">
                            ...
                            <div class="card-body">
                                <div class="contact-form">
                                    ...
                                    {{Form::label('main_taxable', 'Taxable?', ['class' => 'col-xs-2 col-md-2'])}}
                                        <div class="col-xs-10 col-md-10 form-group">
                                            {{Form::radio('main_taxable', 'Yes', $services->first()->main_taxable == "Yes")}}Yes
                                            {{Form::radio('main_taxable', 'No', $services->first()->main_taxable == "No")}}No
                                        </div>
                                    </div>
                                    <?php
                                        $numberOfCounts = $services->count();
                                    ?>
                                    ...
                                    <div class="row to-be-clone" data-increment-id="1" style="border: 1px solid #000;padding: 10px;margin-bottom:5px"><!-- main row open-->
                                        ...
                                        <div class="col-lg-4">
                                            <div class="row">
                                                ...
                                                <div class="col-xs-8 col-md-8 form-group">
                                                    {{ Form::select("service[{$service->id}][servicetype_id]", $servicetype, $service->servicetype_id, ['class' => 'form-control servicetype_id_input', 'data-validation' => 'required']) }}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="row">
                                                ...
                                                <div class="col-xs-8 col-md-8 form-group">
                                                    {{ Form::text("service[{$service->id}][amount]", $service->amount, ['class' => 'form-control amount_input']) }}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="row">
                                                ...
                                                <div class="col-xs-8 col-md-8 form-group">
                                                    {{ Form::radio("service[{$service->id}][taxable]", 'Yes',($service->taxable_stat == "Yes"), ['class' => 'taxable_input', 'id' => 'taxable_id'])}}Yes
                                                    {{ Form::radio("service[{$service->id}][taxable]", 'No', ($service->taxable_stat == "No"), ['class' => ' taxable_input', 'id' => 'taxable_id'])}}No
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="row">
                                                ...
                                                <div class="col-xs-8 col-md-8 form-group">
                                                    {{ Form::textarea("service[{$service->id}][notes]", $service->notes, ['class' => 'form-control notes_input', 'rows' => 2]) }}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 date_en">
                                            <div class="row">
                                                ...
                                                <div class="col-xs-8 col-md-8 form-group">
                                                    {{ Form::date("service[{$service->id}][date]", $service->date, ['class' => 'form-control flat date_input', 'id' => "date_id-{$loop->iteration}", 'placeholder' => 'Pick a Date']) }}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 date_np">
                                            <div class="row">
                                                ...
                                                <div class="col-xs-8 col-md-8 form-group">
                                                    {{ Form::text("service[{$service->id}][date_np]", $service->date_np, ['class' => 'form-control flat_np date_np_input', 'id' => "date_np_id-{$loop->iteration}", 'placeholder' => 'Pick a Date']) }}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="row">
                                                ...
                                                <div class="col-xs-8 col-md-8 form-group recurring-div">
                                                    {{Form::radio("service[{$service->id}][recurring]", 'Yes', ($service->recurring_stat == "Yes"), ['class' => 'recurring_input', 'id' => 'recurring_id'])}}Yes
                                                    {{Form::radio("service[{$service->id}][recurring]", 'No', ($service->recurring_stat == "No"), ['class' => 'recurring_input', 'id' => 'recurring_id'])}}No
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 recurring-type-div" id="type">
                                            <div class="row">
                                                ...
                                                <div class="col-xs-8 col-md-8 form-group">
                                                    {{Form::select("service[{$service->id}][type]", array('1' => 'Every Month', '12' => '1 Year', '24' => '2 Years'), $service->recurring_type, ['id' => 'data', 'class' => 'col-xs-12 col-md-12 form-control type_input', 'placeholder' => 'Pick a type'])}}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
