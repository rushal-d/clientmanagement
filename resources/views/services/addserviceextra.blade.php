...
<section class="padding-block">
    <div class="container-fluid">
        {{ Form::open(['route' => 'service.saveservice']) }}
            <div class="row">
                                    ...
                                    <div class="row to-be-clone" data-increment-id="1" style="border: 1px solid #000;padding: 10px;margin-bottom:5px"><!-- main row open-->
                                        ...
                                        <div class="col-lg-4">
                                            <div class="row">
                                                ...
                                                <div class="col-xs-8 col-md-8 form-group">
                                                    {!! Form::text('service[1][notes]', null, ['class' => 'form-control notes_input']) !!}
                                                </div>
                                            </div>    
                                        </div>
                                        <div class="col-lg-4">
                                        ...
                                        <div class="col-lg-4 recurring-type-div" id="type">
                                            <div class="row">
                                                ...
                                                <div class="col-xs-8 col-md-8 form-group">
                                                        {{Form::select('service[1][type]', array('1' => '1 Year', '2' => '2 Years'), null, ['id' => 'data', 'class' => 'col-xs-12 col-md-12 form-control type_input', 'placeholder' => 'Pick a type'])}}
                                                </div>
                                            </div>    
                                        </div>
                                    </div>
