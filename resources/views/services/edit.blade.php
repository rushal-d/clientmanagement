...
<section class="padding-block">
    <div class="container-fluid">
        {{ Form::open(['route' => ['service.update', 'id' => $service->id], 'method' => 'PATCH']) }}
            <div class="row">
                                ...
                                <div class="contact-form">
                                    <div class="row"><!-- main row open-->
                                        ...
                                        <div class="col-xs-10 col-md-10 form-group">
                                            {!! Form::select('client_id', $client, $service->client_id, ['class' => 'form-control', 'data-validation' => 'required']) !!}
                                        </div>
                                        {!! Form::label('servicetype', 'Service Type: <span class="required-field"> *</span>', ['class' => 'col-xs-2 col-md-2'], false); !!}
                                        <div class="col-xs-10 col-md-10 form-group">
                                            {!! Form::select('servicetype_id', $servicetype, $service->servicetype_id, ['class' => 'form-control', 'data-validation' => 'required']) !!}
                                        </div>
                                        {!! Form::label('amount', 'Amount: <span class="required-field"> *</span>', ['class' => 'col-xs-2 col-md-2'], false); !!}
                                        <div class="col-xs-10 col-md-10 form-group">
                                            {!! Form::text('amount', $service->amount, ['class' => 'form-control', 'data-validation' => 'required']) !!}
                                        </div>
                                        {{Form::label('taxable', 'Taxable?', ['class' => 'col-xs-2 col-md-2'])}}
                                        <div class="col-xs-10 col-md-10 form-group">
                                            {{Form::radio('taxable', 'Yes', ($service->taxable_stat=="Yes"))}}Yes
                                            {{Form::radio('taxable', 'No', ($service->taxable_stat=="No"))}}No
                                        </div>
                                        {!! Form::label('notes', 'Notes: <span class="required-field"> *</span>', ['class' => 'col-xs-2 col-md-2'], false); !!}
                                        <div class="col-xs-10 col-md-10 form-group">
                                            {!! Form::textarea('notes', $service->notes, ['class' => 'form-control', 'rows' => 2]) !!}
                                        </div>
                                        {{Form::label('recurring', 'Recurring?', ['class' => 'col-xs-2 col-md-2'])}}
                                        <div class="col-xs-10 col-md-10 form-group">
                                                {{Form::radio('recurring',  'Yes', ($service->recurring_stat=="Yes"))}}Yes
                                                {{Form::radio('recurring', 'No', ($service->recurring_stat=="No"))}}No
                                        </div>
                                        <div class="form-group col-md-12 col-xs-12" id="type">
                                            <div class="row form-group">
                                                {!!Form::label('recurring_type', 'Recurring Type', ['class' => 'col-xs-2 col-md-2'])!!}
                                                {{Form::select('type', array('none' => '', '1' => '1 Year', '2' => '2 Years'), $service->recurring_type, ['id' => 'data', 'class' => 'col-xs-9 col-md-9 form-control', 'style' => 'margin-left:15px'])}}
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-10 col-xs-10 form-group">
                                            {{Form::date('date', $service->date, ['class' => 'form-control', 'id' => 'date', 'placeholder' => 'Select Date'])}}
                                        </div>
                                    </div>
...
@section('scripts')
<script>
    $_test_variable = '<?php echo $service->recurring_stat ?>';
