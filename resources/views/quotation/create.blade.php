                                    ...
                                    <div class="row to-be-clone" data-increment-id="1" style="border: 1px solid #000;padding: 10px;margin-bottom:5px"><!-- main row open-->
                                        ...
                                        <div class="col-lg-4">
                                            <div class="row">
                                                ...
                                                <div class="col-xs-8 col-md-8 form-group">
                                                    {!! Form::textarea('quotation[1][notes]', null, ['class' => 'form-control notes_input', 'rows' => 2]) !!}
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-4 date_np">
                                            <div class="row">
                                                ...
                                                <div class="col-xs-6 col-md-6 form-group">
                                                    {!! Form::text('quotation[1][date_np]', null, ['class' => 'form-control flat_np date_np_input', 'id' => 'date_np_id', 'placeholder' => 'Pick a Date']) !!}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                        ...
                                        <div class="col-lg-4 recurring-type-div" id="type">
                                            <div class="row">
                                                ...
                                                <div class="col-xs-8 col-md-8 form-group">
                                                        {{Form::select('quotation[1][type]', array('1' => 'Every Month', '12' => '1 Year', '24' => '2 Years'), null, ['id' => 'data', 'class' => 'col-xs-12 col-md-12 form-control type_input', 'placeholder' => 'Pick a type'])}}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
