                            ...
                            <div class="filter">
                                <div class="row form-group">
                                    ...
                                    <div class="filter custom-filter-bar do-not-display-filter-bar-for-small-device col-md-12">
                                        {!! Form::open(['route' => 'quotation.finalized', 'method' => 'GET', 'id' => 'department-form']) !!}
                                        <div class="row">
                                    ...
                                    @forelse($quotations as $quotation)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{route('quotation.showfinalizedquotation', ['quotation_id' => $quotation->quotation_id])}}"
                                                    class="btn btn-sm btn-outline-info">
                                                    <i class="far fa-eye" data-toggle="tooltip" data-placement="top"
                                                    title="View Quotations"></i>
                                                </a>
                                                @if($quotation->next_status != 1)
                                                <a href="{{route('quotation.addtoservices', ['quotation_id' => $quotation->quotation_id])}}"
                                                    class="btn btn-sm btn-success">
                                                    <i class="fas fa-share" data-toggle="tooltip" data-placement="top"
                                                    title="Add to Services"></i>
                                                </a>
                                                @endif
                                                <a href="{{route('quotation.bulkeditfinalized', ['quotation_id' => $quotation->quotation_id])}}"
                                                    class="btn btn-sm btn-success">
